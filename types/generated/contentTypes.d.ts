...
export interface ApiHomeBannerHomeBanner extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    posicion: Schema.Attribute.Integer & Schema.Attribute.Required;
    producto: Schema.Attribute.Relation<'oneToOne', 'api::producto.producto'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiOrdenOrden extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    direccionEnvio: Schema.Attribute.JSON & Schema.Attribute.Required;
    estado: Schema.Attribute.Enumeration<
      ['pendiente', 'pagada', 'enviada', 'entregada', 'cancelada']
    > &
      Schema.Attribute.DefaultTo<'pendiente'>;
    fechaPago: Schema.Attribute.DateTime;
    idPago: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiProductoProducto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    tipo_cafe: Schema.Attribute.Enumeration<
      ['Ex:', 'accesorio', 'grano', 'molido']
    > &
      Schema.Attribute.DefaultTo<'Ex:'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
